...
export class StockController {
  ...
  async getStocks(@Req() req: Request, @Query() options: QueryStockDto) {
    const user = req.user as UserModel;
    const stock = this.stockService.getStocks(user, options);
    //  console.log("stock",await stock);
  ...
  async createStock(
    ...
    const user = req.user as UserModel;
    return this.stockService.createStock(createStockInputs, user);
  }
  ...
  async updateStock(
    ...
    const user = req.user as UserModel;
    return this.stockService.updateStock(createStockInputs, user);
  }
  ...
  async createManyStock(
    ...
    const user = req.user as UserModel;
    return this.stockService.createManyStock(createManyStockInput, user);
  }
