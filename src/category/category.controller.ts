...
export class CategoryController {
  ...
  async createCategory(@Body() createCategoryInput: CreateCategoryInput, @Req() req: Request) {
    const user = req.user as User;
    return this.categoryService.createCategory(createCategoryInput,user.entityId);
  }
}
