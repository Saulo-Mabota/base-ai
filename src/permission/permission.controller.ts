...
export class PermissionController {
  ...
  async createPermission(@Body() createOrUpdatePermissionInput: CreateOrUpdatePermissionInput) {
    return this.permissionService.createPermission(createOrUpdatePermissionInput);
  }

  @Patch(':id')
  @Permissions('update-permission')
  async updatePermission(@Body() createPermissionInput: CreatePermissionInput,@Param('id') id: string) {
